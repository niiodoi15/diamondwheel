...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/DMLogo.png" rel="icon">
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="assets/img/ZZ.jpg" class="d-block w-100" alt="..."  style="">
        ...
        <div class="carousel-item">
          <img src="assets/img/ZZ1.jpg" class="d-block w-100" alt="..."  style="">
          {{-- <div class="carousel-caption d-md-block mb-5" style=" background: hsla(208, 43%, 23%, 0.231); border-radius: 20px; bottom: 50% ">
            <h3>Join The team that truly supports data driven advisory services.</h3>
            
          </div> --}}
        </div>
        <div class="carousel-item">
          <img src="assets/img/Z2.jpg" class="d-block w-100" alt="..."  style="">
          {{-- <div class="carousel-caption d-md-block mb-5" style=" background: #213b523b; border-radius: 20px; bottom: 50% ">
        ...
        <div class="carousel-item">
          <img src="assets/img/ZZ3.jpg" class="d-block w-100" alt="..."  style="">
          {{-- <div class="carousel-caption d-md-block mb-5" style=" background: #213b523b; border-radius: 20px; bottom: 50% ">
      ...
      <div class="container">
        ...
        <div class="row content">
          {{-- <div class="col-md-5" data-aos="fade-right">
            <img src="assets/img/whowe1.png" class="img-fluid" alt="">
          </div> --}}
          <div class="col-md-12" data-aos="fade-left">
            {{-- <h3>Voluptatem dignissimos provident quasi corporis voluptates sit assumenda.</h3> --}}
            <p class="card-text">
              Diamond Wheel Company Limited (DWCL) is a wholly Ghanaian-owned management
consultancy, incorporated in the Republic of Ghana on 7th February 2018. At DWCL, we consider human capital as one of the important assets if not the most
important one and as such health care decisions relating to employees of every corporate institution are very critical to the survivor of their operations. DWCL was set-up to
support management decisions on health care journey of employees and their dependents.
  

            </p>
            <p>
              At DWCL, we are committed to providing sustainable medical and business advisory solutions
that meet the strategic aim of all corporate institutions. DWCL professionals leverages the
strategic vision of senior executives across functional areas, applying our expertise, rigorous
analysis, and deep industry knowledge to develop innovative solutions to our client’s
complex medical and business challenges. At DWCL, we enhance the ability to build value,
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mt-lg-0">
            <form action="https://formspree.io/f/xlekeveb" method="post" role="form" class="php-email-form w-100 pt-5" data-aos="fade-up">
              @csrf
              <div class="row pt-3">
