      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <h3>Email Us</h3>
                  <p>info@diamondwheelconsulting.com</p>
              ...
              <div class="col-md-6">
                <div class="info-box mt-4" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <h3>Call Us</h3>
                  <p>+233 30 396 5676  <br>+233 0552 524 747</p>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            ...
            @endif
            <form action="{{ route('sendMail') }}" method="post" role="form" class="php-email-form w-100" data-aos="fade-up">
              {{csrf_field()}}
              <div class="row">
              ...
              <div class="text-center my-3"><button type="submit" name="submit">Send Message</button></div>
            </form>
          </div>
        </div>
