  ...
  <section id="features" class="features section-bg">
    <div class="container">
      ...
      <div class="section-title">
        <h2 data-aos="fade-in">Employee Wellness Program</h2>
      ...
      <div class="row content">
        ...
        <div class="col-md-9 pt-1" data-aos="fade-right">
            <p>
              Implementing Employee Wellness Programs (EWP) that assure employee productivity, general improvement of employee health and the overall reduction of corporate medical cost is not something that is easily achieved by many institutions. At Diamond Wheel Company Limited, we believe an Employee Wellness Program is surely one of the effective ways of managing occupational health.

            </p>
            <p>
              Our Employee Wellness Program (EWP) is customized to suit the organizational structure, strategies and goals of our client in order to assure effective measurement of program impact on the overall bottom line.
