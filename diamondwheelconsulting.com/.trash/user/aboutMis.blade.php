    ...
    <section id="features" class="features section-bg">
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-md-12 pt-1" data-aos="fade-left">
            <p data-aos="fade-in">To be the leading strategic partner in the provision of sustainable medical and business advisory solutions to corporate and public institutions in Ghana and Africa at large.</p>
          </div>
        </div>
