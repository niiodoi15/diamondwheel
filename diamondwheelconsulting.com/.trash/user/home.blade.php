    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="assets/img/banner1.jpg" class="d-block w-100" alt="..."  style="height: 80vh;">
        ...
        <div class="carousel-item">
          <img src="assets/img/banner2.jpg" class="d-block w-100" alt="..."  style="height: 80vh;">
          <div class="carousel-caption d-md-block mb-5" style=" background: #213b523b; border-radius: 20px; bottom: 50% ">
        ...
        <div class="row content">
          ...
          <div class="col-md-7" data-aos="fade-left">
            ...
            <p class="card-text">
              ...
              in the Republic of Ghana on 7th February 2018. We are committed to providing sustainable
              medical and business advisory solutions that meet the strategic aim of all corporate institutions.  

            </p>
            <p>
              Diamond Wheel Company Limited (DWCL) is a wholly Ghanaian owned management consultancy, 
              incorporated in the Republic of Ghana on 7th February 2018. We are committed to providing sustainable medical 
              and business advisory solutions that meet the strategic aim of all corporate institutions. 
            </p>
