  ...
  <section id="features" class="features section-bg">
    <div class="container">
      ...
      <div class="section-title">
        <h2 data-aos="fade-in">Management of External Medical Referrals</h2>
      ...
      <div class="row content">
        ...
        <div class="col-md-9 pt-1" data-aos="fade-right">
          <p>
            A good referral system involves the interrelationships and coordination of healthcare services from one referring Specialist/Medical Service Provider (MSP’s) to another. This can sometimes be demanding depending on the level of exposure to the health delivery system. 

        </p>
        <p>
          Our medical advisory team will not only simplify these processes for your institution but will serve as the vehicle for an effective referral system that is timely, complete and reliable. 
        ...
        <section class="section-bg">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12">
                    <h2 class="pb-3 text-center" style="color: #38a9ca">Management of External Medical Referrals</h2>
                    <p>
                        A good referral system involves the interrelationships and coordination of healthcare services 
                        from one referring Specialist/Medical Service Provider (MSP’s) to another. 
                        This can sometimes be demanding depending on the level of exposure to the health delivery system. 
                    </p>
                    <p>
                        Our medical advisory team will not only simplify these processes for your institution 
                        but will serve as the vehicle for effective referral system that is timely, complete and reliable. 
                    </p>
                </div>
