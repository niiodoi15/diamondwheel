  ...
  <section id="features" class="features section-bg">
    <div class="container">
      ...
      <div class="section-title">
        <h2 data-aos="fade-in">Business Advisory Services</h2>
      ...
      <div class="row content">
        ...
        <div class="col-md-9 pt-1" data-aos="fade-right">
            <p>
                Assuring sustainable progress in the midst of continuing and often disruptive forces takes 
                insight, acumen, and the ability to effectively leverage the true benefits of data. Our  
                business advisory team develops and offers tailored, innovative, and comprehensive requirements 
                for our clients’ specific business challenges.
            </p>
            <p>
                Led by professionals from various industry and functional specialization, enable our team to 
                effectively implement the appropriate strategies to deliver sustainable and transformational 
                business solutions. 
            </p>
